#define POPULACE_MAX 56       //maximalni pocet jedincu populace
#define MUTACE_MAX 13          //max pocet genu, ktery se muze zmutovat behem jedne mutace (o 1 mensi!)
...
#define PARAM_GENERATIONS 10000000 //max. pocet generaci evoluce
...
#define N_SHUFFLE 543 //If fitness didnt improve for more than N_SHUFFLE gens, shuffle. 
